...
namespace ICanPay.Alipay
{
    public class Order : IOrder
    {
        ...
        /// </summary>
        [JsonProperty(PropertyName = Constant.OUT_TRADE_NO)]
        ...
        /// 销售产品码，与支付宝签约的产品码名称。 
        /// </summary>
        [JsonProperty(PropertyName = Constant.PRODUCT_CODE)]
        ...
        /// 订单标题
        /// </summary>
        [JsonProperty(PropertyName = Constant.SUBJECT)]
        ...
        /// </summary>
        [JsonProperty(PropertyName = Constant.GOODS_DETAIL)]
        ...
        /// </summary>
        [JsonProperty(PropertyName = Constant.PASSBACK_PARAMS)]
        ...
        /// </summary>
        [JsonProperty(PropertyName = Constant.EXTEND_PARAMS)]
		...
		/// 注：虚拟类商品不支持使用花呗渠道
        /// </summary>
        [JsonProperty(PropertyName = Constant.GOODS_TYPE)]
        ...
        /// </summary>
        [JsonProperty(PropertyName = Constant.TIMEOUT_EXPRESS)]
        ...
        /// </summary>
        [JsonProperty(PropertyName = Constant.TIME_EXPIRE)]
        ...
        /// </summary>
        [JsonProperty(PropertyName = Constant.ENABLE_PAY_CHANNELS)]
        ...
        /// </summary>
        [JsonProperty(PropertyName = Constant.DISABLE_PAY_CHANNELS)]
        ...
        /// </summary>
        [JsonProperty(PropertyName = Constant.AUTH_TOKEN)]
		...
		/// 2：订单码-跳转模式
        /// </summary>
        [JsonProperty(PropertyName = Constant.QR_PAY_MODE)]
        ...
        /// </summary>
        [JsonProperty(PropertyName = Constant.QRCODE_WIDTH)]
        ...
        /// 优惠参数 注：仅与支付宝协商后可用
        /// </summary>
        [JsonProperty(PropertyName = Constant.PROMO_PARAMS)]
        ...
        /// </summary>
        [JsonProperty(PropertyName = Constant.STORE_ID)]
        ...
        /// </summary>
        [JsonProperty(PropertyName = Constant.QUIT_URL)]
        ...
        /// </summary>
        [JsonProperty(PropertyName = Constant.BUYER_ID)]
        ...
        /// </summary>
        [JsonProperty(PropertyName = Constant.SELLER_ID)]
        ...
        /// </summary>
        [JsonProperty(PropertyName = Constant.DISCOUNTABLE_AMOUNT)]
        [Range(0.01, 100000000, ErrorMessage = "订单总金额超出范围")]
        ...
        /// 商户操作员编号	
        /// </summary>
        [JsonProperty(PropertyName = Constant.OPERATOR_ID)]

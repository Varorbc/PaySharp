...
3） 此工程可以跑起来测试，建议使用chrome、firefox打开。
  全渠道PC网关/WAP支付产品消费交易示例地址为：http://IP：端口/index_03_token.aspx
───────────
...
upacp_demo_wtz_token
  ...
  │  ├生产环境配置文件
  │  │  │
  │  │  └Web.config ┈┈┈┈┈┈┈┈┈ 【重要】 生产环境配置文件样例（使用方式请看文件里的说明）
  │  │ 
  │  ├测试环境配置文件
  │  │  │
  │  │  └Web.config ┈┈┈┈┈┈┈┈┈ 【重要】 测试环境配置文件样例（使用方式请看文件里的说明）
  │  │ 
  │  └对账文件样例 
  │     │
  ...
  │      │  
  │      ├Form_6_2_ApplyToken.aspx ┈┈┈┈┈ 申请token号示例类
  │      │  
  │      ├Form_6_2_BackOpen.aspx ┈┈┈┈┈ 后台开通示例类
  │      │  
  │      ├Form_6_2_FrontOpen.aspx ┈┈┈┈┈ 前台开通示例类
  │      │  
  │      ├Form_6_3_OpenQuery.aspx ┈┈┈┈┈ 开通状态查询示例类
  │      │  
  │      ├Form_6_4_DeleteToken.aspx ┈┈┈┈┈ 删除token示例类
  │      │  
  │      ├Form_6_5_UpdateToken.aspx ┈┈┈┈┈ 更新token示例类
  │      │  
  │      ├Form_6_6_SmsConsume.aspx ┈┈┈┈┈ 获取消费验证码示例类
  │      │  
  │      ├Form_6_6_SmsOpen.aspx ┈┈┈┈┈ 获取开通验证码示例类
  │      │  
  │      ├Form_6_7_Consume.aspx ┈┈┈┈┈ 消费示例类
  │      │  
  │      ├Form_6_7_FrontOpenConsume.aspx ┈┈┈┈┈ 开通并支付示例类
  │      │  
  │      ├Form_6_8_ConsumeUndo.aspx ┈┈┈┈┈ 消费撤销示例类
  │      │  
  │      ├Form_6_9_Refund.aspx ┈┈┈┈┈ 退货示例类
  │      │  
  │      ├Form_6_10_Query.aspx ┈┈┈┈┈ 交易状态查询示例类
  │      │  
  │      ├Form_7_2_FileTransfer.aspx┈┈┈┈┈ 对账文件下载示例类 （后台）  
  │      │  
  │      ├BackRcvResponse.aspx┈┈┈┈┈ 后台通知示例类  
  │      │  
  │      ├FrontRcvResponse.aspx┈┈┈┈┈ 前台通知示例类
  │      │  
  │      └EncryptCerUpdateQuery.aspx ┈┈┈┈┈ 加密证书更新示例类（后台）
  │  
  ...
  │
  ├Web.config ┈┈┈┈┈┈┈┈┈ 【重要】 配置文件，默认取了“assets/测试环境配置文件”文件夹下的配置文件。
  │
  └index_03_wtz.aspx ┈┈┈┈ demo演示入口页面

───────────
 **注意**

1.【接口规范】该接口参考文档位置：
      接口产品规范：open.unionpay.com帮助中心 下载  产品接口规范  《token产品接口规范》

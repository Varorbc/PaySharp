<form class="api-form" method="post" action="demo/api_03_token/Form_6_6_SmsOpen.aspx" target="_blank">
<p>
<label>商户号：</label>
...
<hr />
<p class="faq">
* 此demo使用的交易卡写死在代码里了，请查看Form_6_6_SmsOpen代码。<br />
</p>

<div class="question" >
<hr />
<h4>获取开通短信验证码您可能会遇到...</h4>
<p class="faq">

<form class="api-form" method="post" action="demo/api_03_wtz/Form_6_3_OpenQuery.aspx" target="_blank">
<p>
<label>商户号：</label>
...
<p>
  <label>商户订单号：</label>
  <input id="orderId" pattern="[0-9a-zA-Z]{8,32}" type="text" name="orderId" placeholder="商户订单号" value="<%= DateTime.Now.ToString("yyyyMMddHHmmss") %>" title="8-32位数字字母，自行定义内容。" required="required"/>
</p>
<p>
<label>&nbsp;</label>
...
<hr />
<p class="faq">
* 此demo使用的交易卡写死在代码里了，请查看Form_6_3_OpenQuery代码。<br />
</p>

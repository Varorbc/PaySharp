...
来自测试支持人员的友情提醒：对发卡行发短信的银行目前不支持开通并支付功能，大行有：中行、浦发，所以非常不推荐用此接口。
<br><br>
交易流程：<br>
<b>开通并消费流程：发开通查询交易，如果卡没开通，做一笔开通并付款交易（卡号必送）<br>
后续消费流程：如果卡已开通则直接做消费（如果消费需要发送短信则消费前调用消费短信交易）</b><br><br>

<b>注：本前台开通因测试商户号777290058110097银联后台配置了 借记卡只支持前台开通，贷记卡只支持后台开通，故本银联侧样例中使用借记卡测试才有权限。</b><br><br>

开通并消费：前台交易，有前台返回商户按钮（前台通知）和后台通知；请求报文中送卡号<br><br>

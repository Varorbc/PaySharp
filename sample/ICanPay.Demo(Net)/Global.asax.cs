...
namespace ICanPay.Demo_Net_
{
    public class Global : HttpApplication
    {
        void Application_Start(object sender, EventArgs e)
        {
            ...
            IGateways gateways = Config();
            ICanPayConfig.Register(typeof(Global), a => gateways);
            ICanPayConfig.Register(typeof(Global), GlobalConfiguration.Configuration, a => gateways);
        }

        private IGateways Config()
        {
